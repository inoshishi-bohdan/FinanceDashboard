...
builder.Services.AddDbContext<FinanceDashboardContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("FinanceDashboardConnectionString")));
